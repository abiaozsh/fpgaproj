...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" DIRECTION="VARIABLE" OPTIMIZE="AREA" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 add_sub clock dataa datab result
...
module  addsub_altbarrel_shift_65e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //addsub_altbarrel_shift_65e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addsub_altbarrel_shift_rlb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[5:0]},
		smux_w = {((({55{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[297:275], pad_w[31:0]}) | ({55{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[329:307]})) | ({55{(~ sel_w[5])}} & sbit_w[329:275])), ((({55{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[258:220], pad_w[15:0]}) | ({55{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[274:236]})) | ({55{(~ sel_w[4])}} & sbit_w[274:220])), ((({55{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[211:165], pad_w[7:0]}) | ({55{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[219:173]})) | ({55{(~ sel_w[3])}} & sbit_w[219:165])), ((({55{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[160:110], pad_w[3:0]}) | ({55{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[164:114]})) | ({55{(~ sel_w[2])}} & sbit_w[164:110])), ((({55{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[107:55], pad_w[1:0]}) | ({55{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[109:57]})) | ({55{(~ sel_w[1])}} & sbit_w[109:55])), ((({55{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[53:0], pad_w[0]}) | ({55{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[54:1]})) | ({55{(~ sel_w[0])}} & sbit_w[54:0]))};
endmodule //addsub_altbarrel_shift_rlb
...
module  addsub_altpriority_encoder_6v7
	...
	addsub_altpriority_encoder_3v7   altpriority_encoder18
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder18_q));
	addsub_altpriority_encoder_3e8   altpriority_encoder19
	( 
	.data(data[3:2]),
...
module  addsub_altpriority_encoder_6e8
	...
	addsub_altpriority_encoder_3e8   altpriority_encoder20
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	addsub_altpriority_encoder_3e8   altpriority_encoder21
	( 
	.data(data[3:2]),
...
module  addsub_altpriority_encoder_bv7
	...
	addsub_altpriority_encoder_6v7   altpriority_encoder16
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder16_q));
	addsub_altpriority_encoder_6e8   altpriority_encoder17
	( 
	.data(data[7:4]),
...
module  addsub_altpriority_encoder_be8
	...
	addsub_altpriority_encoder_6e8   altpriority_encoder22
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	addsub_altpriority_encoder_6e8   altpriority_encoder23
	( 
	.data(data[7:4]),
...
module  addsub_altpriority_encoder_r08
	...
	addsub_altpriority_encoder_bv7   altpriority_encoder14
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder14_q));
	addsub_altpriority_encoder_be8   altpriority_encoder15
	( 
	.data(data[15:8]),
...
module  addsub_altpriority_encoder_rf8
	...
	addsub_altpriority_encoder_be8   altpriority_encoder24
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder24_q),
	.zero(wire_altpriority_encoder24_zero));
	addsub_altpriority_encoder_be8   altpriority_encoder25
	( 
	.data(data[15:8]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addsub_altpriority_encoder_q08
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	addsub_altpriority_encoder_r08   altpriority_encoder12
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder12_q));
	addsub_altpriority_encoder_rf8   altpriority_encoder13
	( 
	.data(data[31:16]),
...
endmodule //addsub_altpriority_encoder_q08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addsub_altpriority_encoder_qf8
	( 
	data,
	q,
	zero) ;
	...
	addsub_altpriority_encoder_rf8   altpriority_encoder26
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder26_q),
	.zero(wire_altpriority_encoder26_zero));
	addsub_altpriority_encoder_rf8   altpriority_encoder27
	( 
	.data(data[31:16]),
...
endmodule //addsub_altpriority_encoder_qf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addsub_altpriority_encoder_0c6
	( 
	data,
	q) ;
	input   [63:0]  data;
	...
	addsub_altpriority_encoder_q08   altpriority_encoder10
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder10_q));
	addsub_altpriority_encoder_qf8   altpriority_encoder11
	( 
	.data(data[63:32]),
...
endmodule //addsub_altpriority_encoder_0c6
...
module  addsub_altpriority_encoder_qh8
	...
	addsub_altpriority_encoder_nh8   altpriority_encoder36
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder36_q),
	.zero(wire_altpriority_encoder36_zero));
	addsub_altpriority_encoder_nh8   altpriority_encoder37
	( 
	.data(data[3:2]),
...
module  addsub_altpriority_encoder_vh8
	...
	addsub_altpriority_encoder_qh8   altpriority_encoder34
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder34_q),
	.zero(wire_altpriority_encoder34_zero));
	addsub_altpriority_encoder_qh8   altpriority_encoder35
	( 
	.data(data[7:4]),
...
module  addsub_altpriority_encoder_fj8
	...
	addsub_altpriority_encoder_vh8   altpriority_encoder32
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder32_q),
	.zero(wire_altpriority_encoder32_zero));
	addsub_altpriority_encoder_vh8   altpriority_encoder33
	( 
	.data(data[15:8]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addsub_altpriority_encoder_ej8
	( 
	data,
	q,
	zero) ;
	...
	addsub_altpriority_encoder_fj8   altpriority_encoder30
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder30_q),
	.zero(wire_altpriority_encoder30_zero));
	addsub_altpriority_encoder_fj8   altpriority_encoder31
	( 
	.data(data[31:16]),
...
endmodule //addsub_altpriority_encoder_ej8
...
module  addsub_altpriority_encoder_q28
	...
	addsub_altpriority_encoder_nh8   altpriority_encoder44
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder44_q),
	.zero(wire_altpriority_encoder44_zero));
	addsub_altpriority_encoder_n28   altpriority_encoder45
	( 
	.data(data[3:2]),
...
module  addsub_altpriority_encoder_v28
	...
	addsub_altpriority_encoder_qh8   altpriority_encoder42
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder42_q),
	.zero(wire_altpriority_encoder42_zero));
	addsub_altpriority_encoder_q28   altpriority_encoder43
	( 
	.data(data[7:4]),
...
module  addsub_altpriority_encoder_f48
	...
	addsub_altpriority_encoder_vh8   altpriority_encoder40
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder40_q),
	.zero(wire_altpriority_encoder40_zero));
	addsub_altpriority_encoder_v28   altpriority_encoder41
	( 
	.data(data[15:8]),
...
module  addsub_altpriority_encoder_e48
	...
	addsub_altpriority_encoder_fj8   altpriority_encoder38
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder38_q),
	.zero(wire_altpriority_encoder38_zero));
	addsub_altpriority_encoder_f48   altpriority_encoder39
	( 
	.data(data[31:16]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addsub_altpriority_encoder_k48
	( 
	data,
	q) ;
	input   [63:0]  data;
	...
	addsub_altpriority_encoder_ej8   altpriority_encoder28
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder28_q),
	.zero(wire_altpriority_encoder28_zero));
	addsub_altpriority_encoder_e48   altpriority_encoder29
	( 
	.data(data[63:32]),
...
endmodule //addsub_altpriority_encoder_k48

//synthesis_resources = lpm_add_sub 9 lpm_compare 1 reg 505 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addsub_altfp_add_sub_8bk
	( 
	add_sub,
	clock,
	dataa,
...
`endif
	...
	addsub_altbarrel_shift_65e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	addsub_altbarrel_shift_rlb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	addsub_altpriority_encoder_0c6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[54:1], 1'b1, {9{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	addsub_altpriority_encoder_k48   trailing_zeros_cnt
	( 
...
endmodule //addsub_altfp_add_sub_8bk
//VALID FILE
...
module addsub (
	...
	addsub_altfp_add_sub_8bk	addsub_altfp_add_sub_8bk_component (
				.add_sub (add_sub),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
